    ...
    <table class="table table-bordered table-striped">
        ...
        @forelse($books as $book)
            <tr>
                ...
                <td>{{ $book->price }}</td>
                <td>
    <a href="{{ route('books.show', $book->id) }}" class="btn btn-sm btn-outline-success">Details</a>
<a href="{{ route('books.edit', $book->id) }}" class="btn btn-sm btn-outline-secondary">Update</a>
